...
В качестве основной модели детекции, несмотря на лучшие показатели YOLO, была выбрана модель FasterRCNN. Ее выбор был обусловлен желанием команды подробнее разобраться с темой computer vision и задействовать в проекте максимальное количество собственного кода без привлечения готовых решений. 
