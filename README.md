...
В качестве основных метрик этапа детекции были выбраны [recision и recall](https://en.wikipedia.org/wiki/Precision_and_recall), а также [F1-score](https://en.wikipedia.org/wiki/F-score). 
...
![F1](https://www.mikulskibartosz.name/assets/images/2019-02-04-f1-score-explained/formula.png)
...
В качестве основных кандидатов на роль модели детекции автомобильных номеров рассматривались модели [FasterRCNN](https://arxiv.org/abs/1506.01497) и [YOLOv5s6](https://github.com/ultralytics/yolov5).
...
| --- | --- | --- | --- |
| FasterRCNN | 0.963 | 0.772 | 0.857 |
| YOLOv5s6 | 0.93 | 0.791 | 0.855 |

В качестве основной модели детекции, при условии небольшой разницы в показателях моделей, была выбрана модель FasterRCNN. Ее выбор был обусловлен желанием команды подробнее разобраться с темой computer vision и задействовать в проекте максимальное количество собственного кода без привлечения готовых решений. 
...
[Ноутбук на kaggle](https://www.kaggle.com/code/flahlight101/notebookbdbb8a3f94)

| Модель | Оптимизатор | Learning rate | Precision | Recall | F1 |
| --- | --- | --- | --- | --- | --- |
| FastRCNN | SGD | 0.005 | 0.963 | 0.772 | 0.857 |
| FastRCNN | SGD | 0.001 | 0.942 | 0.715 | 0.813 |
| FastRCNN | Adam | 0.005 | 0.958 | 0.776 | 0.857 |
| FastRCNN | Adam | 0.001 | 0.944 | 0.712 | 0.812 |
